...
const BACKGROUNDS = {
	...
	Level.GameStyle.SMW: {
		...
		Level.LevelTheme.CASTLE: {
			true: "",
			false: "res://scenes/backgrounds/smw/castle.tscn",
		},
		Level.LevelTheme.SKY: {
			true: "",
			false: "",
		...
		Level.LevelTheme.AIRSHIP: {
			true: "",
			false: "res://scenes/backgrounds/smw/airship.tscn",
		},
		Level.LevelTheme.DESERT: {
			true: "",
			false: "res://scenes/backgrounds/smw/desert.tscn",
		},
		Level.LevelTheme.SNOW: {
			true: "",
			false: "",
		...
		Level.LevelTheme.FOREST: {
			true: "",
			false: "res://scenes/backgrounds/smw/forest.tscn",
		},
		Level.LevelTheme.FALL: {
			true: "",
			false: "res://scenes/backgrounds/smw/fall.tscn",
		},
		Level.LevelTheme.BEACH: {
			true: "",
			false: "res://scenes/backgrounds/smw/beach.tscn",
		},
		Level.LevelTheme.MOUNTAIN: {
			true: "",
			false: "",
